        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body" style="background-color:#76ade3;"><br>
                    <h2 align="center" style="color:white; ">ลงทะเบียน</h2>
                ...
                <img class="position-absolute top-50 start-50 translate-middle" src="{{ asset('images/teamwork.png') }}" style="width: 200px; height: 200px;  margin-right: 180px">
                    ...
                    @endif
                        ...
                        <div class="d-grid gap-4 col-6 mx-auto">
                                <a  class="btn btn-outline-dark"role="button" style="text-transform:none" href="{{ url('auth/google/register') }}"  >
                        ...
                        <p style="text-align:center; ">หากลงทะเบียนแล้ว <a href="{{ route('userlogin') }}">เข้าสู่ระบบ</a></p>
                        <br><br><br>
                    </div>
            </div>
        </div>
