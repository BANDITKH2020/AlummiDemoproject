...
<body>
    ...
    <div class="col-12 row" >
        ...
        <div class="col-10 col-lg-8 mt-5 ms-5">
            <div class="col-md-12">
                <h2 class="text-left">เพิ่มกิจกรรม</h2>
            </div>
            <hr class="mt-1">
            <div class="col-12 ms-5 row ">
                ...
                @csrf
                    ...
                    <div class="col-12 row mt-2">
                        <div class="col-6 ">
                            ...
                            @enderror
                            <h2>วัตถุประสงค์</h2>
                            <textarea type="text"style="font-size: 24px;" name="objective" rows="2" cols="25" class="form-control" aria-label="With textarea"></textarea>
                            @error('objective')
                                <div class="my-2">
                                    <span class="text-danger" style="font-size: 24px;">{{$message}}</span>
                                </div>
                            ...
                            <textarea type="text" style="font-size: 24px;"id="cotent" name="cotent" rows="3" cols="35" class="form-control" aria-label="With textarea" required></textarea>
                            @error('cotent')
                                <div class="my-2">
                                    <span class="text-danger" style="font-size: 24px;">{{$message}}</span>
                                </div>
                        ...
                        <div class="col-6 ">
                            <div class="card mb-4 ms-5 " style="max-width: 350px;max-height: 450px;">
                                <div class="card-body">  
                                <h3>ประเภทกิจกรรม</h3>
                                    <div class="form-check">
                                        <input class="form-check-input " style="font-size: 24px;" type="radio" name="category" id="flexRadioDefault1" value="1">งานพบประสังสรรค์
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input " style="font-size: 24px;" type="radio" name="category" id="flexRadioDefault1" value="2">งานวิชาการ
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input " style="font-size: 24px;" type="radio" name="category" id="flexRadioDefault1"  value="3">งานแข่งขันกีฬา
                                    </div>
                                    <div class="form-check">
