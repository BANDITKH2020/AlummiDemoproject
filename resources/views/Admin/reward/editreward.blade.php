...
<body>
    ...
    <div class="col-12 row" >
        ...
        <div class="col-10 col-lg-8 mt-5 ms-5">
            <div class="col-md-12">
                <h2 class="text-left">แก้ไขรางวัลประกาศ</h2>
            </div>
            <hr class="mt-1">
            ...
            <div class="col-12 row"> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-5 ">
                            <select class="form-select mt-3" name="year" onchange="resultName(this.value);"style="font-size: 24px;" >
                                <option value="{{$reward->year}}">{{$reward->year}}</option>
                                <?php
                ...
                <div class="col-6 col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-5 ">
                            <input type="text" style="font-size: 24px;"class="form-control mt-3" name="student_id" aria-label="student_id" aria-describedby="basic-addon1" value="{{$reward->student_id}}">
                            @error('student_id')
                                <div>
                ...
                <div class="col-6 col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-5 ">
                            <input type="text" style="font-size: 24px;"class="form-control mt-3" name="firstname" aria-label="firstname" aria-describedby="basic-addon1"value="{{$reward->firstname}}">
                            @error('firstname')
                                <div class="my-2">
                                    <span class="text-danger"style="font-size: 24px;">{{$message}}</span>
                                </div>
                ...
                <div class="col-6 col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-5 ">
                            <input type="text" style="font-size: 24px;"class="form-control mt-3" name="lastname" aria-label="lastname" aria-describedby="basic-addon1"value="{{$reward->lastname}}">
                            @error('lastname')
                                <div class="my-2">
                                    <span class="text-danger"style="font-size: 24px;">{{$message}}</span>
                                </div>
                ...
                <div class="col-6 col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-5">
                            <input type="text" style="font-size: 24px;" class="form-control mt-3" name="organizer" aria-label="organizer" aria-describedby="basic-addon1" value="{{$reward->organizer}}" >
                            @error('organizer')
                                <div class="my-2">
                                    <span class="text-danger"style="font-size: 24px;">{{$message}}</span>
                                </div>
                ...
                <div class="col-6 col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-5 ">
                            <input type="text" style="font-size: 24px;"class="form-control mt-3" name="award_name" aria-label="award_name" aria-describedby="basic-addon1" value="{{$reward->award_name}}">
                            @error('award_name')
                                <div class="my-2">
                                    <span class="text-danger"style="font-size: 24px;">{{$message}}</span>
                                </div>
                ...
                <div class="col-6 col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-5">
                            <input type="text"style="font-size: 24px;" class="form-control mt-3" name="amount" aria-label="amount" aria-describedby="basic-addon1" value="{{$reward->amount}}">
                            @error('amount')
                                <div class="my-2">
                                    <span class="text-danger"style="font-size: 24px;">{{$message}}</span>
                                </div>
