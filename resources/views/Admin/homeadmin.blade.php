...
<body>
  ...
  <div class="col-12">
    ...
    <h2 class="text-center">ประชาสัมพันธ์</h2>
    <div class="col-2 mt-3" style="border: 2px solid #000;margin-left:80px;border-radius:10px;background-color: #EFF4FF ">
            ...
            <div class="col-10 mt-1" style="margin-left:50px">
                <a href="๒" class="textmenu"><h5>จัดการข่าวสาร</h5></a>
            </div>
            <div class="col-10 mt-1" style="margin-left:50px">
  ...
  <div class="row" style="position: absolute;left:500px;top: 215px;">
  <div class="col-sm-3">
    <div class="card">
