...
<body>
    ...
    <div class="col-12 row" >
        ...
        <div class="col-10 col-lg-8 mt-5 ms-5">
            <div class="col-md-12">
                <h2 class="text-left">เพิ่มข่าวสาร</h2>
            </div>
            <hr class="mt-1">
            <div class="col-12 ms-5 ">
                ...
                @csrf
                    ...
                    <div class="col-6 mt-2">
                        ...
                        @enderror
                        <h2>เนื้อหา</h2>
                        <textarea type="text" style="font-size: 24px;"id="cotent" name="cotent" rows="5" cols="35" class="form-control" aria-label="With textarea" required></textarea>
                        @error('cotent')
                            <div class="my-2">
                                <span class="text-danger" style="font-size: 24px;">{{$message}}</span>
                            </div>
